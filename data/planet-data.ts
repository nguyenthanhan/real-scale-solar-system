...
export const sunData: PlanetData = {
  ...
  color: "#FDB813",
  sizeRelativeEarth: 109,
  diameterRelativeEarth: 109,
...
export const planetData: PlanetData[] = [
  {
    name: "Mercury",
    sizeRelativeEarth: 0.383,
    diameterRelativeEarth: 0.383,
    color: "#9c9c9c",
    diameterInKm: 4_880,
  ...
  {
    name: "Venus",
    sizeRelativeEarth: 0.949,
    diameterRelativeEarth: 0.949,
    color: "#e39e1c",
    diameterInKm: 12_104,
  ...
  {
    name: "Mars",
    sizeRelativeEarth: 0.532,
    diameterRelativeEarth: 0.532,
    color: "#d14b28",
    diameterInKm: 6_779,
  ...
  {
    name: "Jupiter",
    sizeRelativeEarth: 11.21,
    diameterRelativeEarth: 11.21,
    color: "#d4a373",
    diameterInKm: 139_820,
    distanceInKm: 778_500_000,
    distanceInAU: 5.203,
    orbitSpeedByEarth: 13.07,
    orbitSpeedByKmH: 0.084,
    rotationSpeedByDays: 0.41,
    rotationSpeedByKmH: 47_052,
    hasRings: true,
    ringColor: "#a67c52",
    description:
  ...
  {
    name: "Saturn",
    sizeRelativeEarth: 9.45,
    diameterRelativeEarth: 9.45,
    color: "#f5deb3",
    diameterInKm: 116_460,
    distanceInKm: 1_429_400_000,
    distanceInAU: 9.554,
    orbitSpeedByEarth: 9.69,
    orbitSpeedByKmH: 0.034,
    rotationSpeedByDays: 0.44,
    rotationSpeedByKmH: 34_884,
    hasRings: true,
    ringColor: "#f5c542",
  ...
  {
    name: "Uranus",
    sizeRelativeEarth: 4.01,
    diameterRelativeEarth: 4.01,
    color: "#afeeee",
    diameterInKm: 50_724,
    distanceInKm: 2_870_990_000,
    distanceInAU: 19.191,
    orbitSpeedByEarth: 6.81,
    orbitSpeedByKmH: 0.011,
    rotationSpeedByDays: -0.72,
    rotationSpeedByKmH: 24_516,
    hasRings: true,
    ringColor: "#c0c0c0",
  ...
  {
    name: "Neptune",
    sizeRelativeEarth: 3.88,
    diameterRelativeEarth: 3.88,
    color: "#4169e1",
    diameterInKm: 49_244,
    distanceInKm: 4_498_250_000,
    distanceInAU: 30.069,
    orbitSpeedByEarth: 5.43,
    orbitSpeedByKmH: 0.006,
    rotationSpeedByDays: 0.67,
    rotationSpeedByKmH: 19_548,
    hasRings: true,
    ringColor: "#708090",
